...
const MEDICAL_NOUNS = [
  ...
  // R3 (颜鑫 P2 2026-05-12) adversarial expansion: 中医 + 免疫 + 基因 vectors
  '中草药', '草药', '慢性病', '免疫', '免疫调节', '调节剂', '基因疗法',
  '干预', '预后', '患者', '副作用', '诊断',
];
...
const MEDICAL_ABSOLUTE = [
  ...
  // R3 adversarial: "终极方案" / "革命性突破" / "对所有 X 都有效" / "根本不"
  '革命性', '终极', '都有效', '都管用', '根本不', '不需要西药',
];
...
const FINANCIAL_NOUNS = [
  ...
  // R3 adversarial: 量化 / REITs / ETF / 派息 / 资产配置 / 白马股 / 算法交易
  '量化', '量化交易', 'REITs', 'REIT', 'ETF', '派息', '资产配置', '白马股',
  '算法交易', '目标价', '回测',
];
...
const FINANCIAL_ABSOLUTE = [
  ...
  // R3 adversarial: "三年无亏损" / "年赚 8 位数" / "无亏损月" / "派息率 N%"
  '无亏损', '年赚', '位数', '绝对的稳',
];
...
const ANECDOTE_MARKERS = [
  ...
  // R3 adversarial: 1-doctor "我所有患者" / 1-trader "靠这套算法" generalizations
  '我所有', '我的患者', '我的客户', '我这套', '靠这套', '靠我',
];

const UNIVERSALIZE_MARKERS = [
  '所有人', '所有的', '都会', '人人', '大家都', '任何人', '普遍', '无一例外',
  '一概', '所有', '全都', '从来都', '永远', '没有一个', '任何', '都该', '都应该',
  // R3 adversarial: 普通人也能 / 每个 X 都
  '普通人也', '每个', '人人都能', '谁都能',
];
