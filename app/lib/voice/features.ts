...
const GENERIC_FUNCTION_WORD_RE =
  /(首先|其次|再次|最后|综上所述|众所周知|随着.{0,8}发展|综上来看|总而言之|不可否认|毋庸置疑|一定的(成就|进展|意义|价值|帮助)|根本性的|在特定(应用|场景|情境)中|尽管.{0,15}但|虽然.{0,15}但是|与此同时|值得一提的是|不仅.{0,15}而且|具有重要的.{0,8}意义|主要采用了|主要表现为|主要体现在|为我们提供了|为.{0,5}提供了)/g;
